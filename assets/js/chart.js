...
document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("download").addEventListener("click", function () {
        ...
        const headers = Array.from(document.querySelectorAll(".tables-page__name .tables-page__u"))
            .map(header => header.textContent.trim());

        const rows = Array.from(document.querySelectorAll(".tables-page__string")).map(row => {
            return Array.from(row.querySelectorAll(".tables-page__pole"))
